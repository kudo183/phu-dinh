...
SELECT        dbo.tDonHang.Ngay, dbo.rKhoHang.Ma AS MaKho, dbo.rKhoHang.TenKho, dbo.rKhachHang.Ma AS MaKH, dbo.rKhachHang.TenKhachHang, 
                         dbo.tMatHang.Ma AS MaMatHang, dbo.tMatHang.TenMatHang, dbo.tChiTietDonHang.SoLuong
FROM            dbo.tDonHang INNER JOIN
                         ...
                         dbo.rKhoHang ON dbo.tDonHang.MaKhoHang = dbo.rKhoHang.Ma
GO
...
Begin DesignProperties = 
   ...
   Begin CriteriaPane = 
      Begin ColumnWidths = 11
         Column = 1440
         Alias = 900', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'vDonHang';
