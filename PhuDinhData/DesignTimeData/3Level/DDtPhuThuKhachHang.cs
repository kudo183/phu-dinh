...
{
    public class DDtPhuThuKhachHang
    {
        ...
        private static PhuThuKhachHangViewModel _viewModel;
        public static PhuThuKhachHangViewModel ViewModel
        {
            get
            {
                if (_viewModel != null)
        ...
        public static tPhuThuKhachHang Create(int i)
        {
            return new tPhuThuKhachHang()
            {
                Ma = i,
                MaKhachHang = i,
