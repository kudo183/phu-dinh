...
namespace PhuDinhData.ViewModel
{
    public class CongNoKhachHangViewModel : BaseViewModel<tCongNoKhachHang>
    {
        ...
        void Header_Ngay_PropertyChanged(object sender, PropertyChangedEventArgs e)
        {
            ...
            {
                MainFilter.SetFilter(Filter_tCongNoKhachHang.Ngay, Header_Ngay.Date);
            }
            else
            {
                MainFilter.SetFilter(Filter_tCongNoKhachHang.Ngay, null);
            }
        ...
        {
            MainFilter.SetFilter(Filter_tCongNoKhachHang.TenKhachHang, Header_KhachHang.Text);
