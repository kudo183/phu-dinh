...
{
    public class GiamTruKhachHangViewModel : BaseViewModel<tGiamTruKhachHang>
    {
        ...
        public GiamTruKhachHangViewModel()
        {
            Entity = new ObservableCollection<tGiamTruKhachHang>();
        ...
        void Header_Ngay_PropertyChanged(object sender, PropertyChangedEventArgs e)
        {
            ...
            {
                MainFilter.SetFilter(Filter_tGiamTruKhachHang.Ngay, Header_Ngay.Date);
            }
            else
            {
                MainFilter.SetFilter(Filter_tGiamTruKhachHang.Ngay, null);
            }
        ...
        {
            MainFilter.SetFilter(Filter_tGiamTruKhachHang.TenKhachHang, Header_KhachHang.Text);
        ...
        void Entity_CollectionChanged(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            {
                var tGiamTruKhachHang = e.NewItems[0] as tGiamTruKhachHang;

                tGiamTruKhachHang.Ngay = (Header_Ngay.IsUsed)
                    ? Header_Ngay.Date : DateTime.Now;

                tGiamTruKhachHang.rKhachHangList = _rKhachHangs;

                if (GetDefaultValue(Constant.ColumnName_MaKhachHang) != null)
                {
                    tGiamTruKhachHang.MaKhachHang = Convert.ToInt32(GetDefaultValue(Constant.ColumnName_MaKhachHang));
                }
            }
        }
