...
namespace PhuDinhData.ViewModel
{
    public class GiamTruKhachHangViewModel : BaseViewModel<tGiamTruKhachHang>
    {
        ...
        {
            MainFilter.SetFilter(Filter_tGiamTruKhachHang.Ngay, Header_Ngay.GetFilterValue());
        ...
        {
            MainFilter.SetFilter(Filter_tGiamTruKhachHang.TenKhachHang, Header_KhachHang.GetFilterValue());
