...
namespace PhuDinhData.ViewModel
{
    public class NhanTienKhachHangViewModel : BaseViewModel<tNhanTienKhachHang>
    {
        ...
        void Header_Ngay_PropertyChanged(object sender, PropertyChangedEventArgs e)
        {
            ...
            {
                MainFilter.SetFilter(Filter_tNhanTienKhachHang.Ngay, Header_Ngay.Date);
            }
            else
            {
                MainFilter.SetFilter(Filter_tNhanTienKhachHang.Ngay, null);
            }
        ...
        {
            MainFilter.SetFilter(Filter_tNhanTienKhachHang.TenKhachHang, Header_KhachHang.Text);
