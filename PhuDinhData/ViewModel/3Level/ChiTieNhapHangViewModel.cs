...
namespace PhuDinhData.ViewModel
{
    public class ChiTietNhapHangViewModel : BaseViewModel<tChiTietNhapHang>
    {
        ...
        {
            MainFilter.SetFilter(Filter_tChiTietNhapHang.TenMatHang, Header_MatHang.GetFilterValue());
        ...
        {
            MainFilter.SetFilter(Filter_tChiTietNhapHang.TenNhapHang, Header_NhapHang.GetFilterValue());
        ...
        public override void RefreshData()
        {
            ...
            string msg;
            var trongLuong = BusinessLogics.TinhTrongLuongHang.TinhTrongLuongTheoChiTietNhapHang(Entity, out msg);
