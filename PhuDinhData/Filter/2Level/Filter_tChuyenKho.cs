...
namespace PhuDinhData.Filter
{
    public class Filter_tChuyenKho : FilterBase<tChuyenKho>
    {
        ...
        {
            _filters[MaKhoHangNhap] = FilterNullable(MaKhoHangNhap, setFalse, p => p.MaKhoHangNhap == maKhoHangNhap);
        ...
        {
            _filters[TenKhoHangNhap] = FilterText(TenKhoHangNhap, setFalse, p => p.rKhoHangNhap.TenKho.Contains(tenKhoHangNhap));
        ...
        {
            _filters[MaKhoHangXuat] = FilterNullable(MaKhoHangXuat, setFalse, p => p.MaKhoHangXuat == maKhoHangXuat);
        ...
        {
            _filters[TenKhoHangXuat] = FilterText(TenKhoHangXuat, setFalse, p => p.rKhoHangXuat.TenKho.Contains(tenKhoHangXuat));
